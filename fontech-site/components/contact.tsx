        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
          ...
          >
            ...
            <div className="space-y-5">
              {[
                { icon: WhatsAppIcon, label: "WhatsApp", value: "0704 572 3013", href: "https://wa.me/2347045723013" },
            ...
            {/* CTA WhatsApp */}
            <a
              href="https://wa.me/2347045723013"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 px-6 py-4 bg-[#25D366] text-white font-bold rounded-full w-full justify-center text-base hover:scale-105 transition-transform shadow-[0_0_30px_rgba(37,211,102,0.35)]"
            >
